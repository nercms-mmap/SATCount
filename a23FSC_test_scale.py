...
import a23models_scale as models_mae_cross
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='output_fim6_dir/FSC147.pth', type=str,
                        help='dataset path')
    ...
    parser.add_argument('--resume', default='output_fim6_dir/23checkpoint33-666.pth',
...
def main(args):
    ...
    misc.load_model_FSC_test1(args=args, model_without_ddp=model_without_ddp)
    # misc.load_model_FSC_mae1(args=args, model_without_ddp=model_without_ddp)
