...
data_path = '/home/cliang/wyt/objectcounting/Bilinear-Matching-Network-main/data/'
...
class resizeTrainImage(object):
    ...
    def __call__(self, sample):
        # {'image': image, 'lines_boxes': rects, 'gt_density': density, 'dots': dots, 'id': im_id, 'm_flag': m_flag}
        ...
        sample = {'image':reresized_image,'boxes':boxes,'gt_density':reresized_density, 'm_flag': m_flag, 'hw_mean': hw_mean}
