...
import SATCount_model as models_mae_cross
...
class TestData(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for box in rects:
            ...
            y1, x1, y2, x2 = box2[0], int(box2[1]), box2[2], int(box2[3])
...
def main(args):
    ...
    misc.load_model_satcount_test(args=args, model_without_ddp=model_without_ddp)
